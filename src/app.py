...
activities = {
    ...
    "Art Club": {
        "description": "Explore various visual arts, portfolio development, and exhibitions",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and school play performances",
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["sophia.k@mergington.edu", "michael.b@mergington.edu"]
    }
}
